...
# We are under other system, may be Linux. Assume using gcc.
	# Can we use -fdata-sections?
	ESPPORT ?= /dev/ttyUSB0
	SDK_BASE	?= $(HOME)/private/esp-open-sdk/sdk
...
MODULES		= driver mqtt user modules roomba
EXTRA_INCDIR    = include $(SDK_BASE)/include include/driver
...
BLANKER		:= $(SDK_BASE)/bin/blank.bin
...
flash: $(FW_FILE_1)  $(FW_FILE_2)
	$(ESPTOOL) -p $(ESPPORT) write_flash $(FW_1) $(FW_FILE_1) 0x3C000 $(BLANKER) $(FW_2) $(FW_FILE_2)
